# Fix Error Example - Microsoft.Purview/accounts - 400 IdentityUrl is required
...
It requires the resource to have an identity property. Adding the following config to the `main.tf` will fix the error.
